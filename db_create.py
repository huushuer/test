...
VALUES (?, ?, ?, ?)
''', [
    ('0001', '別名オオパンダとも呼ばれ、中国の四川、陝西、甘粛省の高山地帯に自然生息する大型のクマ科動物である。彼らは最も識別しやすい野生動物の一つで、その特徴的な黒と白の毛皮、大きな丸い体、そして表情豊かな顔で知られている。成体の体重は通常、100〜150キログラムに達し、オスの方がメスよりやや大きい傾向がある。','よく懐いてくれている、happyなアニマルです。そんな彼女は、餌やりカメラに興味津々！皆さんに会えることをとても楽しみにしていたので、ぜひ遊びに来てください！','黄'),
    ('0002', 'ウシ科ヤギ亜科の鯨偶蹄目の動物。 角を持ち、分厚い体毛（羊毛）に覆われている。 主要な家畜であり、ウールを採取するためや羊乳や羊肉を得るために飼育される。草だけでなく、樹皮や木の芽、花も食べる。食草の採食特性は幅広いとされる','よく遊んでいる、マイペースなアニマルです。そんな彼は、餌やりカメラに興味津々！皆さんに会えることをとても楽しみにしていたので、ぜひ遊びに来てください！','黄'),
    ('0003', 'テンジクネズミ科カピバラ属に分類される齧歯類。ヒメカピバラH. isthmiusと2種でカピバラ属を構成する。別名オニテンジクネズミ（鬼天竺鼠）。学名はギリシャ語で水の豚を意味し、漢名も水豚と呼ばれる。現生種の齧歯類では最大の種である。南アメリカ東部アマゾン川流域を中心とした、温暖な水辺に生息する','よく眠っている、のんきなアニマルです。そんな彼は、餌やりカメラに興味津々！皆さんに会えることをとても楽しみにしていたので、ぜひ遊びに来てください！','黄'),
    ('0004', '初生雛は全身が黄色の初生羽に被われ、孵化後48時間程度で大きく白い若羽が生え始める。また、初生雛は腹腔の卵黄を栄養源としているが、ふ化後48時間程度でほとんど消化吸収してしまう。ふ化直後から歩き出し、エサや水も自ら取ることができるが、体温調整機能は不十分である。そのため親鳥が育てる場合ではないときは人の手で管理する必要があり、農場などでは温度や湿度を調整できる幼雛（ようすう）鶏舎で飼育される','当動物園では、ひよこがたくさん孵ります！彼らは、餌やりカメラに興味津々！皆さんに会えることをとても楽しみにしていたので、ぜひ遊びに来てください！','黄'),
    ('0005', 'イエイヌは人間の手によって改良されて生まれたものである。最も古くに家畜化されたと考えられる動物であり、現代でもイエネコと並んで代表的なペットまたはコンパニオンアニマルとして、広く飼育されて、親しまれている。比較されるネコと違って、種の性格として人間にとって人懐っこいイメージがある。','この間、お手が出来るようになりました。そんな彼女は、餌やりカメラに興味津々！皆さんに会えることをとても楽しみにしていたので、ぜひ遊びに来てください！','黄')
])
